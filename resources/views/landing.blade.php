...
<body class="">
    ...
    <header>
        <nav class="navigation">
            ...
            <!--**logo******************-->
            <a href="#" class="logo">
                <img src="{{ asset('images/ChatGPT_Image_24_Apr_2025__15.15.59-removebg-preview.png') }}" alt="logo" />
            </a>
            <!--menu-->
            <ul class="menu">
                ...
                <li><a href="{{ url('/keranjang') }}">Shop</a></li>
    ...
    <section class="sale" id="shop">
        ...
        <a href="#" class="sale-box">
            <img src="{{ asset('images/sale-1.jpg') }}" alt="sale" />
        ...
        <!--box2-->
        <a href="#" class="sale-box">
            <img src="{{ asset('images/sale-2.jpg') }}" alt="sale" />
            ...
            <div class="popular-product-container">
                ...
                <div class="product-box">
                    ...
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/tnda4.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                ...
                <div class="product-box">
                    <!--img-->
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/tas2.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                    <div class="product-box-text">
                ...
                <div class="product-box">
                    <!--img-->
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/shoes2.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                    <div class="product-box-text">
                ...
                <div class="product-box">
                    <!--img-->
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/tas4.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                    <div class="product-box-text">
                ...
                <div class="product-box">
                    <!--img-->
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/sbag2.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                    <div class="product-box-text">
                ...
                <div class="product-box">
                    <!--img-->
                    <a href="#" class="product-box-img">
                        <img src="{{ asset('images/jket3.png') }}" alt="product" />
                        <span>Hot</span>
                    </a>
                    <!--text-->
                    <div class="product-box-text">
    ...
    <section id="recent-product">
        ...
        <div class="recent-product-container">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/shoes3.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/kompas1.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/portabel2.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/jket1.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/botol1.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/jket4.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/sbag1.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
            ...
            <div class="product-box">
                <!--img-->
                <a href="#" class="product-box-img">
                    <img src="{{ asset('images/tas3.png') }}" alt="product" />
                    <span>New</span>
                </a>
                <!--text-->
                <div class="product-box-text">
        ...
        <!--box1-->
        <a href="#" class="sale-box">
            <img src="{{ asset('images/blog-2.jpg') }}" alt="sale" />
            ...
            <div class="blog-container" id="blogContainer">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news1.jpg') }}" alt="blog" />
                    </div>
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news2.jpeg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news3.webp') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news4.jpeg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news5.jpg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news6.jpg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news7.jpg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news8.jpeg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
                ...
                <div class="blog-box">
                    <div class="blog-box-img">
                        <img src="{{ asset('images/news9.jpg') }}" alt="blog" />
                    </div>
                    <div class="blog-box-text">
